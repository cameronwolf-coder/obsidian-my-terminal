...
var TerminalSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Follow active note").setDesc("When you switch to a different note, automatically cd the terminal to that note's directory. Debounced 300ms.").addToggle((t) => t.setValue(this.plugin.settings.followActiveNote).onChange(async (v) => {
